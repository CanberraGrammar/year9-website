...
This assignment was last updated on *Friday 16 February 2018*.
...
That's the end of the page (well, almost). Don't forget: this page must validate as XHTML 1.0 Strict[9].
...
[8] Image source: https://raw.githubusercontent.com/CanberraGrammar/year9-website/master/2018/s1assign1/inside-amazon-go-4.jpg
[9] Text link: http://validator.w3.org
....
...
* The Amazon Go image is available from https://raw.githubusercontent.com/CanberraGrammar/year9-website/master/2018/s1assign1/amazon_go.jpg[https://raw.githubusercontent.com/CanberraGrammar/year9-website/master/2018/s1assign1/amazon_go.jpg^]. Do not locally download the hololens.jpg file to your ED STEM workspace - source the image from github.com using this address.
* The Amazon Go image is linked to: https://www.amazon.com/b?node=16008589011[https://www.amazon.com/b?node=16008589011^].
* The other Amazon Go images are also available from Github (replace amazon-go with inside-amazon-go-1, inside-amazon-go-2, inside-amazon-go-3 and inside-amazon-go-4 for each of the required images)
