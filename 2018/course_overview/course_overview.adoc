...
There's a major final project in Semester Two. There's also an epic overnight hackathon with pizza 🍕 and soft drinks🥤 😎
...
Additional details on the CGS Computing Hackathon’s logistics will be announced when the project specifications are released early in Term 3. This event is voluntary to attend.
