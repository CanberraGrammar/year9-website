...
*Weight:* 40% +
*Due:* Thursday 24 May 2018 (Week 14) by 8:45am

== Changelog ==

This assignment was last updated on *Monday 2 April 2018*.
...
You may select a partner from a different Year 9 IT class, but your partner must be in Year 9 (even though the Year 8 classes are doing this same assignment you cannot team up with a Year 8 student).

=== Get started ===

Once you have formed into a team contact your teacher via email so we can record your team members. *This must be done by the end of Term 1 (Friday 13 April 2018).*
...
You must place the following declaration (in the form of a comment) at the top of the first page in your website (i.e. the `index.html` page in the root of your workspace file/folder structure):
