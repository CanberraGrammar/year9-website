...
^.^| *Term 1*
2+^.^|
*Topic 1: Introduction to the Linux CLI* +
2+^.^|
*Topic 2: Introduction to Vim* +
1+^.^|
*Topic 3: ES6* +
5+^.^|
*Topic 4: Introduction to Node.JS* +

{set:cellbgcolor:white}
^.^| *Term 2*
9+^.^|
*Topic 5: Writing Node.JS Web Apps* +
|
...
{set:cellbgcolor:white}
3+^.^|
*Topic 6: Introduction to Xcode and Swift* +
5+^.^|
*Topic 7: SpriteKit Game Development* +
2+^.^|
*Topic 8: App Mini Projects* +

{set:cellbgcolor:white}
^.^| *Term 4*
3+^.^|
*Topic 8: App Mini Projects (cont.)* +
^.^| *Assessment Week*
{set:cellbgcolor:grey}
^.^|
...
. developing an understanding of how to use the Linux command line together with common text editing tools, particularly Vim, found on all systems
...
** Google Chrome
** ED STEM IDE
** Amazon EC2 Linux on t3.nano Instance*
...
*The Amazon EC2 Linux on t3.nano instance costs $35 for Semester One* and will be also charged to your school account.

== Final Project

The climax of this course is the final project. The final project is your opportunity to take your newfound savvy with app development out for a spin and develop an app either using Node.JS for web or SpriteKit for iOS. So long as your project draws upon the course’s lessons, the nature of your project is entirely up to you, albeit subject to your teacher's approval.
