...
5+^.^|
*Topic 7: SwiftUI App Development* +
3+^.^|
*Topic 8: SpriteKit Game Development* +
...
The climax of this course is the final project. The final project is your opportunity to take your newfound savvy with app development out for a spin and develop an app using either SwiftUI or SpriteKit for iOS. So long as your project draws upon the course’s lessons, the nature of your project is entirely up to you, albeit subject to your teacher's approval.
