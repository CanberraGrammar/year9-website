...
:page-title: Year 9 IT - Course Overview

= Year 9 IT

Year 9 Web and Mobile App Development is a one year course that forms part of the Information Technology program at Canberra Grammar School. The course is aligned with the Digital Technologies curriculum from the Australian Curriculum, going into more detailed study of concepts covered in Year 8 IT.

The course requires students to have studied Year 8 IT at Canberra Grammar School or have equivalent programming knowledge.

== tl;dr

=== About

This course will teach you how to develop web-based apps, using a combination of JavaScript (client-side) and Node.JS (server-side), and also how to develop native mobile apps for iOS, using the Swift programming language and Xcode IDE.
...
* Physics and collision detection in SpriteKit
* App Projects
...
*Topic 1: Linux CLI* +
1+^.^|
*Topic 2: Getting setup* +
4+^.^|
*Topic 3: Getting started with Node.js* +
4+^.^|
*Topic 4: Using Express with Node.js* +

{set:cellbgcolor:white}
^.^| *Term 2*
4+^.^|
*Topic 5: Using MongoDB with Node.js* +
5+^.^|
*Topic 6: Building models with Node.js* +
|
...
{set:cellbgcolor:white}
2+^.^|
*Topic 6: Introduction to Swift* +
5+^.^|
*Topic 7: Introduction to SpriteKit* +
3+^.^|
*Topic 8: Physics and collision detection in SpriteKit* +

{set:cellbgcolor:white}
^.^| *Term 4*
3+^.^|
*Topic 9: App Projects* +
^.^| *Assessment Week*
{set:cellbgcolor:grey}
^.^|
...
. developing an understanding of how to use the Linux command line

. learning how to write server-side application code in Node.js to develop full client-server web-based applications

. learning how to develop native mobile applications for iOS using Swift and the Xcode IDE

. developing mobile games using SpriteKit and learning how the framework provides advanced features such as collision detection and physics simulation
...
* *Semester One:*
** *Textbook:* Get Programming with Node.JS by Jonathan Wexler. https://www.manning.com/books/get-programming-with-node-js[Please purchase the eBook edition for US$39.99 via this link^].
** Google Chrome
** ED STEM IDE
** Node.js, Express.js, MongoDB (all freely downloadable)
...
The climax of this course is the final project. The final project is your opportunity to take your newfound savvy with app development out for a spin and develop a game using SpriteKit for iOS. So long as your project draws upon the course’s lessons, the nature of your project is entirely up to you, albeit subject to your teacher's approval.
