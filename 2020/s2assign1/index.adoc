...
This assignment was last updated on *Wednesday 19 August 2020*.
...
To submit, ZIP your *entire Xcode project folder* and upload the file to http://submit.cgscomputing.com/year9-s2assign1[http://submit.cgscomputing.com/year9-s2assign1^]. Make sure to correctly enter your name and school email address, so that your submission can be located.
