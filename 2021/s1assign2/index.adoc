...
This assignment was last updated on *Wednesday 19 May 2021*.

* *UPDATE 19 May 2021:* The submission instructions were updated with a higher maximum word count and video length.
...
* *Executable application files:* A .app file (Mac users, preferred option) or .zip file (Windows users) containing an .exe file along with the application data folder.
...
The maximum length of submission is one of the following options:

* 4000 words for a design document without any video
* 10 minutes for a video without a design document
* A combination of 2000 words for the design document and 5 minutes for the video

Headings, images and references are not included as part of the word count.
